...
async function GetOrderList() {
    ...
    try {
        const orders = await $.ajax({
            url: '/Order/GetIsConfirmedOrderList',
            type: 'get',
            dataType: 'json',
                ...
                },
                {
                    ...
                    render: function (data) {
                        return '<button class="btn btn-primary btn-sm ms-1" onclick="editCompany(\'' + data + '\')">Edit</button>' + ' ' +
                            ...
                            '<button class="btn btn-primary btn-sm ms-1" onclick="OrderDispatch(\'' + data + '\')">Dispatch</button>';
                    }
                }
            ]
        });
...
window.OrderDispatch = async function (id) {
    try {
        const data = await $.ajax({
            url: '/Order/GetById/' + id,
            type: 'get',
        ...
        $('#IsReadyToDispatch').prop('value', data.isReadyToDispatch ? "true" : "true");
